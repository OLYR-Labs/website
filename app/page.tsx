...
export default function Home() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#030405] text-[#F5F5F5]">
      {/* ========================================================= */}
      {/* HERO */}
      {/* ========================================================= */}
          ...
          <div className="grid overflow-hidden rounded-2xl border border-white/[0.08] md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              <Reveal key={service.number} delay={index * 80}>
                <Link
                  href="/services"
                  className="group relative block min-h-[300px] overflow-hidden border-b border-r border-white/[0.08] bg-[#050505] p-8 transition-colors duration-500 hover:bg-[#080b10] sm:p-10"
                >
