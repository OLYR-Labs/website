...
const solutions = [
  { title: "Web Development", summary: "Fast, polished websites that make your business look credible and convert visitors.", includes: ["Business websites", "E-commerce", "CMS & SEO"] },
  { title: "Mobile Apps", summary: "Customer and staff apps built around the way people actually use your business.", includes: ["iOS & Android", "Cross-platform apps", "API integrations"] },
  { title: "Software & Web Apps", summary: "Custom systems that replace messy processes with simple, useful software.", includes: ["Business software", "Web apps & portals", "APIs & integrations"] },
  { title: "ERP & POS Systems", summary: "Connected operations for sales, inventory, teams, customers, and reporting.", includes: ["ERP systems", "POS workflows", "Inventory & reports"] },
  { title: "AI Integration", summary: "Useful AI inside your products and workflows — without the hype.", includes: ["AI assistants", "Data & document AI", "AI-powered workflows"] },
  { title: "Cybersecurity", summary: "Practical security work that finds weaknesses and helps you fix them.", includes: ["Security reviews", "Vulnerability assessment", "Hardening guidance"] },
  { title: "Business Automation", summary: "Less repetitive work. Better connected systems. More time for the business.", includes: ["Workflow automation", "System integrations", "Notifications & tasks"] },
];
