...
```
  ...
  <section className="relative px-4 py-4 sm:px-6 lg:px-8">
    ...
    <div className="glass-panel relative flex min-h-screen items-center rounded-[2rem]">
      ...
      <div className="pointer-events-none absolute -left-40 top-1/4 h-[500px] w-[500px] rounded-full bg-blue-600/[0.08] blur-[160px]" />

      <div className="pointer-events-none absolute -right-40 bottom-0 h-[450px] w-[450px] rounded-full bg-blue-500/[0.05] blur-[160px]" />

      {/* Hero visual layer */}
      {/* ReactiveHero must also have pointer-events-none on its root */}
      ...
      <div className="relative z-50 mx-auto w-full max-w-7xl px-6 pb-20 pt-40 lg:px-8">
        ...
        <Reveal delay={200}>
          ...
          <div className="mt-12 flex flex-col justify-between gap-10 border-t border-white/10 pt-8 md:flex-row md:items-end">
        ...
        <Reveal delay={300}>
          ...
          <div className="group relative mt-24 h-[300px] overflow-hidden rounded-3xl border border-white/[0.08] bg-[#050505] sm:h-[420px]">
            ...
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
              ...
              <div className="absolute left-1/2 top-1/2 h-[300px] w-[300px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/[0.08] blur-[100px] transition duration-1000 group-hover:scale-150 group-hover:bg-blue-500/[0.14]" />
            ...
            <div className="pointer-events-none absolute inset-0 opacity-30">
              ...
              <div className="absolute inset-[-50px] animate-[gridMove_20s_linear_infinite] bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:50px_50px]" />
            ...
            <div className="pointer-events-none relative flex h-full items-center justify-center">
              ...
              <div className="relative text-center">
                ...
                <div className="mx-auto mt-8 h-px w-24 bg-gradient-to-r from-transparent via-blue-400 to-transparent opacity-60" />
            ...
            <div className="pointer-events-none absolute inset-0 rounded-3xl border border-transparent transition duration-700 group-hover:border-blue-400/20" />
  ...
  <section className="px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
    ...
    <div className="glass-section mx-auto max-w-7xl rounded-[2rem] p-6 sm:p-10 lg:p-12">
  ...
  <section className="px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
    ...
    <div className="mx-auto max-w-7xl">
      ...
      <Reveal delay={100}>
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/[0.18] bg-white/[0.055] p-[1px] shadow-[0_30px_100px_rgba(0,0,0,0.25),inset_0_1px_0_rgba(255,255,255,0.15)] backdrop-blur-2xl">

          <div className="pointer-events-none absolute -inset-20 bg-blue-500/[0.06] blur-[120px]" />

          <div className="pointer-events-none absolute inset-0 rounded-[2.5rem] bg-[linear-gradient(120deg,rgba(255,255,255,0.10),transparent_25%,transparent_65%,rgba(96,165,250,0.06))]" />
  ...
  <section className="px-4 pb-4 sm:px-6 lg:px-8">
    ...
    <div className="glass-panel relative overflow-hidden rounded-[2rem] py-40">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/10 blur-[160px]" />
        ...
        <Reveal delay={200}>
          ...
          <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              ...
              className="rounded-full border border-white/20 bg-white/[0.02] px-8 py-4 text-sm font-semibold transition duration-300 hover:border-blue-400 hover:bg-blue-400/5"
            >
              Chat on WhatsApp
            </a>
