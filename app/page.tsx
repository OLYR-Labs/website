          ...
          <div className="max-w-5xl">
            ...
            <Reveal delay={200}>
              ...
              <p className="mt-8 max-w-2xl text-lg leading-8 text-[#A1A1AA] sm:text-xl">
                ...
                and technology solutions that help businesses grow, improve,
                and stay secure.
        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:px-8">
          ...
          <Reveal delay={150}>
            ...
            <div className="space-y-6 text-lg leading-8 text-[#A1A1AA]">
              ...
              <p>
                OLYR Labs is a technology company focused on building
                innovative solutions for an increasingly digital world.
              </p>



              <p>
                From intelligent software and artificial intelligence to
                cloud infrastructure and cybersecurity, we explore technology
                that helps individuals and businesses grow, improve, and stay secure.
              </p>
          ...
          <div className="grid border-l border-t border-white/10 sm:grid-cols-2">
            ...
            {capabilities.map((capability, index) => (
              ...
              >
                ...
                <Link
                  href="/services"
                  className="group block border-b border-r border-white/10 p-8 transition hover:bg-white/[0.03] sm:p-10"
                >
