          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg leading-8 text-[#A1A1AA]">
              <p>
                ...
                create opportunities, and help people and businesses move
                forward.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid border-l border-t border-white/10 sm:grid-cols-2">
            {capabilities.map((capability, index) => (
              <div
                key={capability}
                className="group border-b border-r border-white/10 p-8 sm:p-12"
              >
                <div className="mb-20 text-sm text-[#52525B]">
                  0{index + 1}
                </div>

                <h3 className="text-2xl font-semibold">{capability}</h3>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-px border border-white/10 bg-white/10 sm:grid-cols-2">
            {values.map((value) => (
              <div
                key={value.number}
                className="bg-[#050505] p-8 sm:p-12"
              >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-5xl">
            ...
            <h2 className="text-4xl font-semibold leading-tight tracking-[-0.04em] sm:text-6xl">
              To build technology that earns trust, creates opportunity, and
              helps shape a better digital future.
            </h2>
          </div>
        </div>
      </section>
      ...
      <section className="py-40">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          ...
          <p className="mx-auto mt-8 max-w-xl text-lg leading-8 text-[#A1A1AA]">
            Have an idea, a challenge, or a problem worth solving? We'd love
