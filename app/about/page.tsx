...
const values = [
  { title: "Useful", text: "We build solutions that solve real problems." },
...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-[var(--background)] text-[var(--text)]">
      <section className="border-y border-[var(--border)] pt-28 sm:pt-36">
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-6 sm:py-20 lg:grid-cols-[0.55fr_1.45fr] lg:px-8 lg:py-24">
          <Reveal><p className="text-xs font-semibold uppercase tracking-[0.25em] text-[var(--accent)]">Who We Are</p></Reveal>
          <Reveal delay={100}>
            <div>
              <h1 className="max-w-3xl font-[var(--font-space-grotesk)] text-3xl font-semibold tracking-[-0.05em] sm:text-5xl">We build software and digital solutions for businesses.</h1>
              <p className="mt-6 max-w-2xl text-base leading-8 text-[var(--muted)]">OLYR Labs builds websites, software, AI solutions, cybersecurity services, ERP and POS systems, and business automation.</p>
            </div>
          </Reveal>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden py-20 sm:py-28">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          <Reveal><p className="text-xs font-semibold uppercase tracking-[0.25em] text-[var(--accent)]">What we explore</p><h2 className="mt-4 font-[var(--font-space-grotesk)] text-4xl font-semibold tracking-[-0.06em] sm:text-6xl">Where ideas become useful products.</h2></Reveal>
