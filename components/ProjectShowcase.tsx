...
export default function ProjectShowcase() {
  ...
  return (
    <div
      ...
      className="group relative min-h-[500px] overflow-hidden rounded-[2.4rem] border border-white/[0.14] bg-black/40 transition-transform duration-300 ease-out"
      style={{
        transform: `
          perspective(1200px)
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-30 rounded-[2.4rem] bg-[linear-gradient(120deg,rgba(255,255,255,0.04),transparent_25%,transparent_70%,rgba(96,165,250,0.02))]" />
      ...
      <div
        className="pointer-events-none absolute h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-600/10 blur-[150px] transition-[left,top] duration-700 ease-out"
        style={{
          left: `${position.x}%`,
          top: `${position.y}%`,
        }}
          ...
          return (
            ...
            >
              <button
                ...
                className="group/node relative flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-white/10 bg-white/[0.025] backdrop-blur-xl transition-all duration-500"
              >
                {/* Outer glow */}
                ...
                <span
                  className={`relative z-10 block h-2 w-2 rounded-full bg-blue-400 shadow-[0_0_20px_rgba(59,130,246,0.9)] transition-all duration-500 ${node.animation} ${
                    isHovered
                ...
                <span
                  className={`pointer-events-none absolute left-1/2 top-full mt-4 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/15 bg-black/50 px-4 py-2 text-[9px] font-medium tracking-[0.2em] text-white shadow-[0_15px_50px_rgba(0,0,0,0.5)] backdrop-blur-2xl transition-all duration-300 ${
                    isHovered
