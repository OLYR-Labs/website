...
const phoneNumber = "94781026353";

const message = encodeURIComponent(
"Hi OLYR Labs! I'm interested in working with you. I'd like to know more about your services."
);
...
return ( <a
   ...
   aria-label="Chat with OLYR Labs on WhatsApp"
